...
# if there are posting data, make aviable the project
	...
	*/
	...
	if($_POST['submitted'] != $_SESSION['project_confirm_ID']){
		die("Confirmation code is not valid!");
	}
	...
	*/
	...
	# create images dir
	mkdir("misc/groupware/writeable/projects/shared/".$_GET['id']."/images/");

	# move project to active dir
	# ATTENTION TO 'type'
	copy("misc/groupware/writeable/projects/".$_GET['type']."/".$_GET['id'].".xml", "misc/groupware/writeable/projects/active/".$_GET['id'].".xml");
	unlink("misc/groupware/writeable/projects/".$_GET['type']."/".$_GET['id'].".xml");
