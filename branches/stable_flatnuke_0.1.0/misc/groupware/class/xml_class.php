<?php
/*
 * $Id: xml_class.php,v 0.36RC2 2005/10/26 22:38:27 gigasoft Exp $
 * XML class
 * Copyright (C) 2003-2005 Giovanni Piller Cottrer
 *
...
var $indentations = 0;
	...
	*/
	function createXMLFile($encoding = " encoding=\"UTF-8\"", $disable_direct_acess = false){
		if($encoding = " "){
