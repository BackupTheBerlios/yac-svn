...
if(file_exists("misc/groupware/lang/".YAC_LANG."/main.php")){
	require_once("misc/groupware/lang/".YAC_LANG."/main.php");
}else{
	require_once("misc/groupware/lang/en/main.php");
}
...
define("GROUPWARE_ISACTIVE", true);
 ...
 /**
 * used for check email
 *
 * @author Giovanni Piller Cottrer <giovanni.piller@gmail.com>
 *
 * @var bool
 */
define("GROUPWARE_CHECK_EMAIL", "giovanni.piller@gmail.com");
 ...
 * @var bool
 */
define("GROUPWARE_TITLE", "YAC more than a Groupware");
 ...
 * @var bool
 */
define("GROUPWARE_CURRENT_USER", $_COOKIE['myforum']);
